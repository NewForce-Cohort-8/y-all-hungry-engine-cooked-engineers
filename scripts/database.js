	...
	iceCream: [
		{
			...
			price: 8.5,
			desc: "The Chunk Monk basically turns banana nutbread into an ice cream flavor and adds large chunks of dark chocolate to it, which makes it a sort of combination of banana nutbread and frozen chocolate banana flavors.",
		},
		{
			id: 2,
			name: "So Basic",
			...
			price: 6.0,
			desc: "So Basic is a sweet frozen dessert made from milk, cream, sugar, and vanilla flavoring from vanilla seeds, pure vanilla extract, vanilla seed paste, or a combination.",
		},
		{
			id: 3,
			name: "Mocha Much?",
			...
			price: 7.5,
			desc: "This decadent homemade mocha ice cream recipe gets its rich flavor from brewed coffee and semisweet chocolate and its creaminess from an egg custard made with whipping cream and half-and-half.",
		},
		{
			id: 4,
			...
			price: 7.0,
			desc: "Chocolate Thunder ice cream is made with heavy whipping cream, unsweetened cocoa powder, sweetened condensed milk, vanilla, and chocolate chunks. ",
		},
		{
			id: 5,
			name: "Golden Girl",
			...
			price: 8.5,
			desc: " Golden Girl ice cream is creamy and sweet with that signature cheesy tang reminiscent of its divine pastry counterpart, cheesecake.",
		},
		{
			id: 6,
			name: "Deez Nuts",
			...
			price: 8.5,
			desc: "Deez Nuts features a peanut butter ice cream swirled with chocolatey waffle cone pieces and a fudge swirl.",
		},
		{
			id: 7,
			...
			price: 8.5,
			desc: " Red, ripe, juicy strawberries churned and frozen with some fresh cream and a bit of sugar is all that is needed to make a delicious Berry Bitty City ice cream.",
		},
		{ id: 8, name: "None", img: "", price: 0.0, desc: "none" },
	],
