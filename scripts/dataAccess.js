...
export const completeOrder = () => {
	...
	customOrder.salesTax = customOrder.price * .06
	customOrder.price += customOrder.salesTax
    database.customOrders.push(customOrder);
	html += `for a total price of <strong>$${customOrder.price.toFixed(2)}</strong>. 
	<br>
	<br>
	Your order is <strong>Order #${customOrder.orderId}</strong>. It'll be ready in 10-15 minutes. Thank you!`
    console.log(
